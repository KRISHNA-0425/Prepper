    ...
    return (
        <div className="min-h-screen bg-[#F5EC5A] flex items-center justify-center px-6 py-20 overflow-hidden relative">
            ...
            <div className="w-full max-w-md bg-[#FFFDE7] border border-[#F9F046] rounded-3xl p-10 relative z-10 shadow-xl animate-[cardIn_0.6s_cubic-bezier(0.34,1.56,0.64,1)_both]">
                ...
                {/* Google Button */}
                <button onClick={handleGoogleAuth} className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-2xl border-[1.5px] border-[#e8df00] bg-white text-[#1a1a00] font-medium text-base hover:bg-[#F5EC5A] hover:-translate-y-0.5 hover:scale-[1.02] active:scale-95 transition-all duration-200">
