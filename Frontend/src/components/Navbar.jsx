...
import { RiCoinsLine, RiLogoutBoxRLine, RiArrowDownSLine, RiFlashlightLine, RiHistoryLine } from "react-icons/ri";
                ...
                <div className='flex items-center gap-2 md:gap-3'>
                    {userData ? (
                                        ...
                                        >
                                            <div className='flex flex-col items-center text-center gap-3'>
                                                ...
                                                <button 
                                                    ...
                                                    className='w-full py-2.5 bg-yellow-400 text-white font-black rounded-xl md:rounded-2xl text-xs md:text-sm hover:bg-yellow-500 transition-colors'
                                                >
                                                    Top Up
                                                </button>
                                            </div>
                                ...
                                <AnimatePresence>
                                    {isDropdownOpen && (
                                        ...
                                        >
                                            ...
                                            <button 
                                                onClick={() => { navigate('/history'); setIsDropdownOpen(false); }} 
                                                className='w-full flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:bg-yellow-50 rounded-xl font-bold transition-all'
                                            >
                                                <RiHistoryLine size={18} /> History
                                            </button>
                                            <button 
                                                onClick={handleLogout} 
                                                className='w-full flex items-center gap-3 px-4 py-3 text-sm text-red-500 hover:bg-red-50 rounded-xl font-bold transition-all'
                                            >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className='bg-[#F7D63A] text-[#8B7D10] px-6 py-2.5 rounded-full font-black text-sm shadow-md'
                        >
                            Get Started
                        </motion.button>
                    )}
